...
<head>
    ...
    <title>Radio Taxis Mandarinas | Taxis</title>
    <meta name="format-detection" content="telephone=no">
    <meta name="keywords" content="Radio taxis, mandarinas, taxis torreón, taxis mandarinas">
    <meta name="description" content="Servicio las 24 horas del día los 365 días del año.">
    <!--===== FAVICON =====-->
    ...
    <!--<link rel="stylesheet" href="https://site-assets.fontawesome.com/releases/v6.1.0/css/all.css.css">-->
    <!--====== MAIN CSS ======-->
