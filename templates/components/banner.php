...
<div class="banner">
    <div class="banner__mask">
        <div class="banner__content banner__content--p3 mt7">
            <h1 class="banner__title" data-aos="fade-up">> OFRECEMOS UNA VARIEDAD DE SERVICIOS.</h1>
            <h2 class="banner__title" data-aos="fade-down"><i class="fa-solid fa-phone"></i> (871) 718 1111</h2>
        </div>  
