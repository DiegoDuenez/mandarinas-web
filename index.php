...
<head>
    ...
    <title>Radio Taxis Mandarinas</title>
    <meta name="format-detection" content="telephone=no">
    <meta name="keywords" content="Radio taxis, mandarinas, taxis torreón, taxis mandarinas">
    <meta name="description" content="Somos una organización de taxis, gruas y transportes de cargas ligeras ubicados en la ciudad de Torreón Coahuila, México.">
    <!--===== FAVICON =====-->
